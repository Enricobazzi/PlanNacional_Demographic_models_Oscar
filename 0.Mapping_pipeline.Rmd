...
# rm ${i}_sorted.bam
# rm ${i}_sorted_rmdup.bam
java -jar /home/tmp/Software/GATK_3.4/GenomeAnalysisTK.jar -T RealignerTargetCreator -nt 24 -R $REF -fixMisencodedQuals -I ${i}_sorted_rmdup_sorted.bam -o ${i}_realignertargetcreator.intervals
# IndelRealigner
