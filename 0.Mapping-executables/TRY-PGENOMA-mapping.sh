...
PGenomaARRAY=($(ls /home/ebazzicalupo/try_fastqs/Enrico_move/*.fastq.gz | rev | cut -d'/' -f 1 | rev | cut -d '_' -f1,2,3 | uniq))
...
PGenomaPATH=/home/ebazzicalupo/try_fastqs/Enrico_move
...
# mkdir try_fastqs
# mkdir try_fastqs/Enrico_move
## generate FASTQs:
# for i in ${PGenomaARRAY[@]}
#   do
#     echo ${i}
#     zcat /home/ebazzicalupo/fastqs/Enrico_move/${i}_1.fastq.gz | \
#     head -40000 > /home/ebazzicalupo/try_fastqs/Enrico_move/${i}_1_10kr.fastq
#     bgzip /home/ebazzicalupo/try_fastqs/Enrico_move/${i}_1_10kr.fastq
#     zcat /home/ebazzicalupo/fastqs/Enrico_move/${i}_2.fastq.gz | \
#     head -40000 > /home/ebazzicalupo/try_fastqs/Enrico_move/${i}_2_10kr.fastq
#     bgzip /home/ebazzicalupo/try_fastqs/Enrico_move/${i}_2_10kr.fastq
# done
...
for i in ${PGenomaARRAY[@]}
  do
    ...
    echo -e " ********************** \n\n - Mapping ${i} - \n\n **********************"
    bwa mem $REF $PGenomaPATH/${i}_1_10kr.fastq.gz $PGenomaPATH/${i}_2_10kr.fastq.gz \
