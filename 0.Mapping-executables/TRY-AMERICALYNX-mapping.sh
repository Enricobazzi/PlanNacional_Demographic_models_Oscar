...
LCA_3ARRAY=($(ls /home/ebazzicalupo/try_fastqs/LCA_3/*.fastq.gz | rev | cut -d'/' -f 1 | rev | cut -d '_' -f1,2 | uniq))
# List of all Lynx rufus sample codes in PN2017:
LRU_30ARRAY=($(ls /home/ebazzicalupo/try_fastqs/LRU_30/*.fastq.gz | rev | cut -d'/' -f 1 | rev | cut -d '_' -f1,2 | uniq))
...
OUT=/home/ebazzicalupo/try_bams
# path to fastq files:
LCA_3PATH=/home/ebazzicalupo/try_fastqs/LCA_3
LRU_30PATH=/home/ebazzicalupo/try_fastqs/LRU_30
...
# mkdir try_fastqs/LCA_3
# mkdir try_fastqs/LRU_30
# # generate FASTQs:
# for i in ${LCA_3ARRAY[@]}
#   do
#     echo ${i}
#     zcat /GRUPOS/grupolince/PN2017/LCA_3/${i}_AGTTCC_R1.fastq.gz | \
#     head -40000 > /home/ebazzicalupo/try_fastqs/LCA_3/${i}_AGTTCC_R1_10kr.fastq
#     bgzip /home/ebazzicalupo/try_fastqs/LCA_3/${i}_AGTTCC_R1_10kr.fastq
#     zcat /GRUPOS/grupolince/PN2017/LCA_3/${i}_AGTTCC_R2.fastq.gz | \
#     head -40000 > /home/ebazzicalupo/try_fastqs/LCA_3/${i}_AGTTCC_R2_10kr.fastq
#     bgzip /home/ebazzicalupo/try_fastqs/LCA_3/${i}_AGTTCC_R2_10kr.fastq
# done
#
# for i in ${LRU_30ARRAY[@]}
#   do
#     echo ${i}
#     zcat /GRUPOS/grupolince/PN2017/LRU_30/${i}_GGTAGC_R1.fastq.gz | \
#     head -40000 > /home/ebazzicalupo/try_fastqs/LRU_30/${i}_GGTAGC_R1_10kr.fastq
#     bgzip /home/ebazzicalupo/try_fastqs/LRU_30/${i}_GGTAGC_R1_10kr.fastq
#     zcat /GRUPOS/grupolince/PN2017/LRU_30/${i}_GGTAGC_R2.fastq.gz | \
#     head -40000 > /home/ebazzicalupo/try_fastqs/LRU_30/${i}_GGTAGC_R2_10kr.fastq
#     bgzip /home/ebazzicalupo/try_fastqs/LRU_30/${i}_GGTAGC_R2_10kr.fastq
# done
...
for i in ${LCA_3ARRAY[@]}
  do
    ...
    echo -e " ********************** \n\n - Mapping ${i} - \n\n **********************"
    bwa mem $REF $LCA_3PATH/${i}_AGTTCC_R1_10kr.fastq.gz $LCA_3PATH/${i}_AGTTCC_R2_10kr.fastq.gz \
...
for i in ${LRU_30ARRAY[@]}
  do
    ...
    echo -e " ********************** \n\n - Mapping ${i} - \n\n **********************"
    bwa mem $REF $LRU_30PATH/${i}_GGTAGC_R1_10kr.fastq.gz $LRU_30PATH/${i}_GGTAGC_R2_10kr.fastq.gz \
    -t $THREADS | samtools view -hbS -@ $THREADS - -o $OUT/${i}.cat_ref.bam
    echo " - Sorting ${i} -"
    samtools sort -@ $THREADS $OUT/${i}.cat_ref.bam -o $OUT/${i}.cat_ref.sorted.bam \
    && rm $OUT/${i}.cat_ref.bam
