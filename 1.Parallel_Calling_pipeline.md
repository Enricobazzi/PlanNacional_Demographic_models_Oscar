...
It appears that for default settings the maximum run time is of 4 days. This means that I will have to submit 1 chromosome at the time. I can probably submit jobs for all the individuals for 2 chromosomes at the time. So the script should include also the target chromosome.
